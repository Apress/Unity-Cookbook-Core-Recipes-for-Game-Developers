...
public static class Utils
{
    ...
    ***/
    ...
    public static void DrawRay(Vector3 start, Vector3 direction, float length, Color color, LineRenderer lineRenderer)
    {
        if (lineRenderer == null)
        {
            Debug.LogError("LineRenderer is null. Please provide a valid LineRenderer.");
            return;
        }
